...
const GalleryModal = () => {
	return (
		<div className="gallery-modal">
			<button
				type="button"
				className="gallery-modal-button py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600/50 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none absolute top-0 left-0 bottom-0 right-0"
