...
const AboutUsSection = () => {
	return (
		<div className="about-us-section w-full max-w-7xl px-4 md:px-6 lg:px-8 py-12 lg:py-24 mx-auto border-t-2 border-t-slate-100">
			<div className="mb-6 sm:mb-10 max-w-2xl text-center mx-auto">
				...
				<p className="text-left font-sans mb-8">
					Over the last few years, many car enthusiasts have started turning
					their attention to recent vehicles – cars from the 1980s, 1990s, and
					beyond. Automotive reviewer Doug DeMuro realized there isn’t yet a
					specific place that’s focused solely on buying and selling these
					modern enthusiast cars, but there should be – so he and a team created
					Cars & Bids, with its simple name modeled after Doug’s famous pursuit
					of “quirks and features.”
				</p>
				<p className="text-left font-sans mb-8">
					Cars & Bids is the best online auction marketplace to buy and sell
					modern enthusiast cars – and that means pretty much anything that’s
					cool from the 1980s, 1990s, 2000s, 2010s, or 2020s. To us, “cool”
					ranges from the obvious (a Ferrari F355 or a Lamborghini Gallardo) to
					the esoteric (a pristine Dodge Dakota Convertible or a Mercury Capri
					XR2) to the traditional fun cars that enthusiasts love (a Mazda MX-5
					Miata or a Porsche 911). Basically everything that’s exciting, fun,
					interesting, or quirky is welcome here – as long as it comes from the
					modern era.
				</p>
				<p className="text-left font-sans mb-8">
				...
				<ul className="list-disc ml-4">
					<li className="font-sans text-left pl-2 mb-8">
						<strong>We’re focused on modern enthusiast cars:</strong> the 1980s
						to the 2020s. That means anyone interested in the next era of
						exciting cars will come here first to buy and sell.
					</li>
					<li className="font-sans text-left pl-2 mb-8">
					...
					<li className="font-sans text-left pl-2 mb-8">
						<strong>
							Doug DeMuro will bring extra eyes – and extra buyers – to your
							cars,
						</strong>
					...
					<li className="font-sans text-left pl-2 mb-8">
						...
						means you don’t have to waste your time providing initial
						information only to have your car rejected.
					</li>
					<li className="font-sans text-left pl-2 mb-8">
						<strong>
					...
					<li className="font-sans text-left pl-2 mb-8">
						...
						step-by-step checklist to ensure a smooth sale – and we’re just a
						chat away if you have any questions.
					</li>
				</ul>
			</div>
		</div>
