...
const Card = ({ href, src, alt, title, description }: CardProps) => {
	return (
		<Link className="group block" href={href}>
			...
			<div className="pt-4">
				<h3 className="relative inline-block font-medium font-sans text-lg text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 before:transition before:origin-left before:scale-x-0 group-hover:before:scale-x-100 dark:text-white">
					{title}
				</h3>
				<p className="mt-1 font-sans text-gray-600 dark:text-neutral-400">
					{description}
				</p>
			</div>
		</Link>
...
const FeaturedInventorySection = ({
	...
	return (
		...
		<div className="featured-inventory-section w-full max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
			<div className="mb-6 sm:mb-10 max-w-2xl text-center mx-auto">
				<h2 className="font-medium font-display text-black text-2xl uppercase sm:text-4xl dark:text-white">
					Featured Inventory
				</h2>
			</div>
			<CardGrid>
			...
			<div className="mt-10 lg:mt-20 text-center">
				<a
					className="relative inline-block font-medium md:text-lg font-sans text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white"
					href="/inventory">
					View all inventory
				</a>
			</div>
